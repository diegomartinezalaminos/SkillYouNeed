...
public class UserProfileActivity extends AppCompatActivity {
    ...
    private ScrollView scrollViewOwnUserUserProfile;
    private Button buttonDeleteOwnUserUserProfile, buttonLoginOutUserProfile, buttonSaveChangeUserProfile;
    private EditText editTextOwnNameUserProfile, editTextOwnEmailUserProfile;
